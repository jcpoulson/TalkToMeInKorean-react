            ...
            <Row justify="center" style={rowStyle}>
                <Col style={colStyle} xs={{span: "20"}} sm={{span: "20"}} xl={{span: "15"}} align="center">
                    <Form
                        ...
                        >
                            <Input id="firstname-input" defaultValue={firstName}/>
                        </Form.Item>
                        ...
                        >
                            <Input id="lastname-input" defaultValue={lastName} />
                        </Form.Item>
                        ...
                        <Form.Item
                            ...
                            id="email"
                        >
                            <Input id="email-input" defaultValue={AppState.user.email} />
                        </Form.Item>
                        ...
                        <Form.Item
                            ...
                            id="adress"
                        >
                            <Input id="address-input" defaultValue={"12345 someplace somewhere Reston, VA 20190 United States"} />
                        </Form.Item>
