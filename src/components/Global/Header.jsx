...
const AppHeader = () => {
    ...
    return (
        <Layout style={style}>
                ...
                <Col style={style} xl={{ span: 12 }} xxl={{ span: 5}}>
                    <Menu mode="horizontal" className="top-nav-menu">
                        { AppState.user.firstName ? <SubMenu title={`${AppState.user.firstName} ${AppState.user.lastName}`}>
                            <Menu.Item><Link passHref href="/profile">User Profile</Link></Menu.Item>
                            <Menu.Item onClick={() => {
                                AppState.setUser({})
                                Cookies.remove('authenticatedUser')
                                }}><Link passHref href="/">Sign Out</Link></Menu.Item>
                        </SubMenu> 
                        : 
                        <Menu.Item><Link passHref href="/signin">Sign In</Link></Menu.Item>
                        }
                        <SubMenu title="Support">
                            
                                <Menu.Item><Link passHref href="/coming-soon">FAQ</Link></Menu.Item>
                                <Menu.Item><Link passHref href="/coming-soon">Contact Us</Link></Menu.Item>
                            
                            
                                <Menu.Item><Link passHref href="/coming-soon">How to use the site</Link></Menu.Item>
                                <Menu.Item><Link passHref href="/coming-soon">TTMIK Map</Link></Menu.Item>
            ...
            <Row justify="center">
                <Col style={style} className="header-bottom-col" xl={{ span: 5}} xxl={{ span: 5}}><Link passHref href="/"><Image src={TTMIKLogo} width={140} height={75} className="ttmik-logo" layout="fixed" alt="ttmik logo"/></Link></Col>
