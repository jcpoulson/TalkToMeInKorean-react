            ...
            </Row>
            {
                ...
                <div className="text-book-carousel">
                    <Carousel style={{width: "55%", marginLeft: "auto", marginRight: "auto", marginTop: "2.5%", marginBottom: "2.5%"}} autoplay>
                        <Image src={textBook1} alt="textbook 1" />
                        <Image src={textBook2} alt="textbook 2" />
                        <Image src={textBook3} alt="textbook 3" />
                        <Image src={textBook4} alt="textbook 4" />
                        <Image src={textBook5} alt="textbook 5" /> 
                    </Carousel>
                </div>
