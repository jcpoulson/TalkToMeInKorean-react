            ...
            <Row justify="center" style={{marginTop: "10%"}}>
                {
                    ...
                    <Col span={12} style={{borderTop: "dotted 1px grey"}}>
                        ...
                        <Image src={PremiumSymbol} alt="premium symbol" />
                    </Col>
                    :
                ...
                <Layout>
                    <Row justify="center" style={{marginTop: "2.5%"}}>
                        <Col sm={8} xxl={{span: 5}} style={{height: "200px"}}>
                            <Image src={DialogVideos} alt="sample dialog videos" />
                            <h1 style={titleStyle}>Sample dialogue videos</h1>
                        </Col>
                        <Col sm={8} xxl={{span: 5}}>
                            <Image src={ComprehensionQuizzes} alt="comprehension quizzes" />
                            <h1 style={titleStyle}>Comprehensions quizzes</h1>
                        </Col>
                        <Col sm={8} xxl={{span: 5}}>
                            <Image src={PremiumLesson} alt="hundreds of premium lessons" />
                            <h1 style={titleStyle}>Hundreds of premium lessons</h1>
                        </Col>
                    </Row>
                    <Row justify="center">
                        <Col sm={8} xxl={{span: 5}}>
                            <Image src={Certificate} alt="Certificates for each course" />
                            <h1 style={titleStyle}>Certificate for each course</h1>
                        </Col>
                        <Col sm={8} xxl={{span: 5}}>
                            <Image src={StudySupport} alt="Lesson recommendations" />
                            <h1 style={titleStyle}>Lesson recommendations</h1>
                        </Col>
                        <Col sm={8} xxl={{span: 5}}>
                            <Image src={LessonNote} alt="Downloadable lesson notes" />
